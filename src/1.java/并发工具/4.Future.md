...
主要的操作支持获取结果和取消执行。(与Thread相比可以更简单的获取结果【thread只支持执行Runnable】和取消执行)
...
![CompletionStage1.png](..%2Fimage%2FCompletionStage1.png)
![CompletionStage2.png](..%2Fimage%2FCompletionStage2.png)
可见方法的命名遵循以下的规则：
...
```
![CompletableFuture-一元依赖.gif](..%2Fimage%2FCompletableFuture-%E4%B8%80%E5%85%83%E4%BE%9D%E8%B5%96.gif)
...
```
![CompletableFuture-二元依赖.png](..%2Fimage%2FCompletableFuture-%E4%BA%8C%E5%85%83%E4%BE%9D%E8%B5%96.png)

#### 2.2.2.3 多元依赖：allof...
![completableFuture-allof.png](..%2Fimage%2FcompletableFuture-allof.png)
